INITIAL_OUTLINE_WRITER_MODEL = (
    "ollama://qwen2.5:0.5b"  # Note this value is overridden by the argparser
)
CHAPTER_OUTLINE_WRITER_MODEL = (
    "ollama://qwen2.5:0.5b"  # Note this value is overridden by the argparser
)
CHAPTER_STAGE1_WRITER_MODEL = "ollama://qwen2.5:0.5b"  # Note this value is overridden by the argparser
CHAPTER_STAGE2_WRITER_MODEL = "ollama://qwen2.5:0.5b"  # Note this value is overridden by the argparser
CHAPTER_STAGE3_WRITER_MODEL = "ollama://qwen2.5:0.5b"  # Note this value is overridden by the argparser
CHAPTER_STAGE4_WRITER_MODEL = "ollama://qwen2.5:0.5b"  # Note this value is overridden by the argparser
CHAPTER_REVISION_WRITER_MODEL = (
    "ollama://qwen2.5:0.5b"  # Note this value is overridden by the argparser
)
REVISION_MODEL = "ollama://qwen2.5:0.5b"  # Note this value is overridden by the argparser
EVAL_MODEL = "ollama://qwen2.5:0.5b"  # Note this value is overridden by the argparser
INFO_MODEL = "ollama://qwen2.5:0.5b"  # Note this value is overridden by the argparser
SCRUB_MODEL = "ollama://qwen2.5:0.5b"  # Note this value is overridden by the argparser
CHECKER_MODEL = "ollama://qwen2.5:0.5b"  # Model used to check results
TRANSLATOR_MODEL = "ollama://qwen2.5:0.5b"
...
# Tested models:
"qwen2.5:0.5b"  # works as editor model, DO NOT use as writer model, it sucks
